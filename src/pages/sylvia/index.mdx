...
It allows the users to focus purely on bussiness logic by generating message
...
dispatching the messages, or even helpers for multitest. It allows for better
control of interfaces, including validating their completeness in compile time.
