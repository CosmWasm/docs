...
Let me introduce [`MultiTest`](../../cw-multi-test) - a library for creating tests for smart
contracts in Rust.

The core idea of [`MultiTest`](../../cw-multi-test) is to abstract smart contracts and simulate the
...
First, we need to add [`MultiTest`](../../cw-multi-test) to our `Cargo.toml`.
