...
access any value associated with a key, as long as you know the key (with or without a prefix).
The following example firstly assigns value to a key in line 9, and then reads the value from
storage in line 13. The key can be any binary.
