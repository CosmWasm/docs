...
As you can see, the contract itself sends the message to initialize the channel
handshake in this example. Please note that the rest of the handshake still
needs to be done by a relayer.
