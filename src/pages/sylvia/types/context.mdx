...
Sylvia exposes context types to wrap the
[`Deps/DepsMut`](../../core/entrypoints.mdx#depsdepsmut),
[`Env`](../../core/entrypoints.mdx#env), and
[`MessageInfo`](../../core/entrypoints.mdx#messageinfo) types received in the
