...
The following examples demonstrate how to generate a Bech32 address with a specified prefix using
two common approaches: the `addr_make` function and the `IntoAddr`, `IntoBech32` and `IntoBech32m`
traits.
