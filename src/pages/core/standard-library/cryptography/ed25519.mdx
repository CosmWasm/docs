...
Ed25519 is known to [have issues with inconsistent validation criteria], the API we offer follows [ZIP215].
This means you will have no issues with signatures being valid in one place and invalid in another.
