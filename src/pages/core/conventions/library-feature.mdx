...
<Callout>
  ...
  contracts](https://github.com/CosmWasm/cw-plus). Here is an example in the
  [`cw4-stake`
  contract](https://github.com/CosmWasm/cw-plus/blob/48bec694521655d5b3e688c51e4185f740ea4640/contracts/cw4-stake/Cargo.toml#L22-L24).
</Callout>
