...
integration tests (**`MultiTest`** tests) **\<line 12\>** and zero for documentation tests **\<line
16\>**.
...
As expected, the current code coverage for the **counter** smart contract is zero since we haven't
