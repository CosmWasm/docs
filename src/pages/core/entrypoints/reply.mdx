...
This endpoint gets invoked when your contract receives some kind of message from
the outside. For example when the execution of an external contract you called
