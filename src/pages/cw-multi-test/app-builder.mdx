...
data beyond the test execution. Any values stored in it during testing are lost once the test completes.

To use the default storage you just initialize a chain with default settings
