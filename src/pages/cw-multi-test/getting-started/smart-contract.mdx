...
**contract.rs** files, respectively. You can freely copy and paste this content, temporarily
skipping the detailed explanations. However, if you're curious about what is inside, feel free to
check the detailed descriptions provided below each file.
