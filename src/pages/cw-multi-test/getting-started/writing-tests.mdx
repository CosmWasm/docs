...
<details>
  <summary>
    📃  Code coverage report for <strong> counter </strong> smart contract (CosmWasm version)
  </summary>
...
<details>
  <summary>
    📃  Code coverage report for <strong> counter </strong> smart contract (Sylvia version)
  </summary>
...
<Callout type="info" emoji="☕">
  Choose below the appropriate card to start writing your first test for **counter** smart contract
  written using pure CosmWasm or the Sylvia framework.
</Callout>
