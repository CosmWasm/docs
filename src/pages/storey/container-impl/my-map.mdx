...
We can iterate over everything. Note we didn't have to write any special logic for this nesting in
our custom container's implementation. It's well integrated with Storey simply by implementing a few
traits.
