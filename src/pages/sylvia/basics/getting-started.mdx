...
To use Sylvia follow the [`installation`](../../core/installation) process for the `CosmWasm core`.
...
In Vim you can consider installing the [rustaceanvim](https://github.com/mrcjkb/rustaceanvim)
plugin.
