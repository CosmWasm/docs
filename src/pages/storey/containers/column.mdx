...
let messages: Vec<_> = access.bounded_pairs(Some(0), Some(1)).collect::<Result<_, _>>().unwrap();
...
[`Map`]: https://docs.rs/storey/latest/storey/containers/struct.Map.html
[`MapAccess`]: https://docs.rs/storey/latest/storey/containers/struct.MapAccess.html
