...
browser. As expected, the current code coverage for the **counter** smart contract is 𝟎 since we
haven't written any tests yet. Follow the next chapters, and make the code coverage report shine
green 🟢.
