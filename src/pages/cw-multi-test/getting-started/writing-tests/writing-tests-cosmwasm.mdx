...
<Callout type="info" emoji="☉">
  The final content of the `test_counter.rs` file, containing all test cases, is presented [at the
  end](#test-cases-put-all-together) of this chapter.
</Callout>
...
cases for **counter** smart contract written in CosmWasm.
